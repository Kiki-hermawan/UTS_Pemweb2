...
<body>
  ...
  <?php
    ...
    $query = "SELECT * FROM tbbuku WHERE id = $id";
    // Hasil Query
    ...
    <div class="col-md-6 offset-md-3 align-self-center"> 
      ...
      <form method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="inputpenulis" value="<?= $data['penulis'] ?>" name="penulis" placeholder="Masukan Penulis">
        </div>
        <div class="mb-3">
          <label for="inputpenerbit" class="form-label">Penerbit</label>
          <input type="text" class="form-control" id="inputpenerbit" value="<?= $data['penerbit'] ?>" name="penerbit" placeholder="Masukan Penerbit">
        </div>
        <input name="rekam" type="submit" class="btn btn-primary" value="Update">
  ...
  <?php
    ...
    if(isset($_POST['rekam'])){
      ...
      // Membuat Query
      $query = "UPDATE tbbuku SET judul = '$judul', penulis = '$penulis', penerbit = '$penerbit' WHERE id = '$id'";
